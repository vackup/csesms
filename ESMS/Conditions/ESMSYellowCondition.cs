...
namespace CSEsMS.ESMS.Conditions
{
    ...
    /// <author>   Angelo
    /// </author>
    public class ESMSYellowCondition:Engine.Conditions.YellowCondition, ESMSCondition
    {
		
        /// <summary>Creates a new instance of ESMSInjCondition </summary>
        public ESMSYellowCondition(Condition cond):base((YellowCondition) cond)
        {
        ...
        public virtual bool isTrue(ESMSTeam team, ESMSTeam away, int min)
        {
            ...
            if (!isNumber)
            {
                if (team.getPosition(team.YellowCarded).Equals(player))
                    return true;
                else
                    return false;
            }
            ...
            {
                if (team.YellowCarded.Name.Equals(team.getPlayer(number).Name))
                    return true;
                else
                    return false;
            }
