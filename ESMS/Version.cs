...
namespace CSEsMS.ESMS
{
    ...
    public class Version
    {
        ...
        //UPGRADE_NOTE: The initialization of  'lastBuild' was moved to static method 'ESMS.Version'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
        ...
        private static string programName = "JEsMS";
        private static string shortName = "JEsMS";
        private static int major = 1;
        private static int minor = 0;
        private static int build = 8;
        private static string revision = "424:425";
        private static string codename = "Romeo";
		
        private static string ported = "2.6";
        ...
        static Version()
        {
            ...
            SupportClass.CalendarManager.manager.Set(temp_calendar, 2005, 4, 8);
