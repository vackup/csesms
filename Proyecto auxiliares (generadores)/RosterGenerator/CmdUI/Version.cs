...
namespace RosterGenerator
{
	...
	public class Version
	{
		...
		//UPGRADE_NOTE: The initialization of  'lastBuild' was moved to static method 'RosterGenerator.Version'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		private static System.String programName = "JEsMS Roster Generator";
		private static System.String shortName = "RGenerator";
		...
		static Version()
		{
			...
			SupportClass.CalendarManager.manager.Set(temp_calendar, 2004, 9, 4);
