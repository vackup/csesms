...
namespace Leaders
{
	...
	public class Version
	{
		...
		//UPGRADE_NOTE: The initialization of  'lastBuild' was moved to static method 'Leaders.Version'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		private static System.String programName = "JEsMS Leaders calculator";
		private static System.String shortName = "Leaders";
		...
		static Version()
		{
			...
			SupportClass.CalendarManager.manager.Set(temp_calendar, 2005, 2, 19);
