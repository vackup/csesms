...
namespace League
{
	...
	public class Version
	{
		...
		//UPGRADE_NOTE: The initialization of  'lastBuild' was moved to static method 'League.Version'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		private static System.String programName = "JEsMS League updater";
		private static System.String shortName = "League";
		...
		static Version()
		{
			...
			SupportClass.CalendarManager.manager.Set(temp_calendar, 2004, 9, 11);
