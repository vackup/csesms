...
namespace TeamSheetCreator.Comparators
{
	...
	/// </author>
	public class DefenderComparator : System.Collections.IComparer
	{
		
		/// <summary>Creates a new instance of DefenderComparator </summary>
		public DefenderComparator()
		{
		}
		...
		public virtual int Compare(System.Object obj, System.Object obj1)
		{
			...
			if (P2.Tackling != P1.Tackling)
				return P2.Tackling - P1.Tackling;
			else
				return P2.getTacklingAbility() - P1.getTacklingAbility();
		}
	}
}