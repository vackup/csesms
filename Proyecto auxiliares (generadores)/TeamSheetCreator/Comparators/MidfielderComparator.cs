...
namespace TeamSheetCreator.Comparators
{
	...
	/// </author>
	public class MidfielderComparator : System.Collections.IComparer
	{
		
		/// <summary>Creates a new instance of DefenderComparator </summary>
		public MidfielderComparator()
		{
		}
		...
		public virtual int Compare(System.Object obj, System.Object obj1)
		{
			...
			if (P2.Passing != P1.Passing)
				return P2.Passing - P1.Passing;
			else
				return P2.getPassingAbility() - P1.getPassingAbility();
		}
	}
}